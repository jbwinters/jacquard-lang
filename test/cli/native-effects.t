...
passing them directly to each engine to retain defensive runtime coverage.
  ...
  identical: g49-text-literal-patterns (exit 0)
...
unchecked/host-driven second resume reaches byte-identical E0906 in both runtimes.
  ...
  generated 30 once-hostile cases from reviewed inventory
  ...
  > done; echo "$passed/30 generated once-operation cases reject identically"
  30/30 generated once-operation cases reject identically
