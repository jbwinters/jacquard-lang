...
a label with different field types across constructors (E1240), and an accessor name that an
explicit term of the same file also defines (E1241) are refused at the label.
