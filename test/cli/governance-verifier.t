...
`jac governance check` command; this transcript pins the GM.8 analysis lane.
  ...
  $ echo "GM.8 verifier: valid Workspace plus 32 adversarial corpus cases passed before runtime"
  GM.8 verifier: valid Workspace plus 32 adversarial corpus cases passed before runtime
