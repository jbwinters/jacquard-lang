...
| (GM.9 authority-order parity) | g38-governance-authority.jqd | `governance.validate-authority` accepts Net→Secret and structured unknown/Resource order, including `a < a: < a::` and the configuration tie-break, while reversed and duplicate cases refuse byte-identically |
