...
SRC="$here/jq_alloc.c $here/jq_rc.c $here/jq_text.c $here/jq_error.c $here/jq_show.c $here/jq_utf8.c $here/jq_rng.c $here/jq_apply.c $here/jq_intrinsics.c $here/test/test_runtime.c"
