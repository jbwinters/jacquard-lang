...
The GM.9 checkout contains 632 compiled Alcotest/QCheck cases, 32 cram
transcript files, 23 documentation examples, and 44 interpreter/native gauntlet
twins. The complete native walk reports 69 identical programs, eight manifested
refusals, and zero failures. Historical GM.1, GM.2, and GM.5 evidence remains
unchanged; this file and exact manifest are a successor overlay.
