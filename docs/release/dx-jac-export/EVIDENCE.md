...
- Alcotest/QCheck cases: `662`
- Cram transcript files: `35`

The test count includes six DX.2 filesystem-boundary cases. The additional
cram transcript is `test/cli/export.t`.
