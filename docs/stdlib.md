...
The complete blessed effect vocabulary—including schema-reserved interfaces,
risk defaults, user-effect coloring rules, exact hashes, and
...
| reserved/unimplemented (8) | `Choose`, `Env`, `Pg`, `Blob`, `Serve`, `Crypto`, `Log`, `Judge` |
...
identity and contract but no runtime until SC.14. The other eight reserved
