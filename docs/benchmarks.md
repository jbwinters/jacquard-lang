...
The first four have hand-C and Python twins in bench/ref/. The rest
are language-specific (handlers, multi-shot, code values) or aggregate
batteries; their columns are the two engines only.
...
| pure | 3303 ms | 12 ms | — | — | — | — |
| avl | 6442 ms | 14 ms | — | — | — | — |
| state-loop | 24181 ms | 159 ms | 211 ms | — | — | — |
| enum | 10698 ms | 14 ms | 22 ms | — | — | — |
| mutate | 2558 ms | 4 ms | 5 ms | — | — | — |
...
python3 bench/ref/fib.py              # Python twins: fib, sort, sum, text
```
