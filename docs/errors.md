...
| E0908 | an internal scheduler operation is illegal for the task's current lifecycle or continuation ownership | checking out a suspended task or completing a task twice |
