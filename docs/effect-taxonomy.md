...
| D59 | Proposal schema | semantic identity and authority are mandatory; GM.0 D67 supersedes the earlier `subject` field name with exact `call-id` and `proposal-id` schemas |
